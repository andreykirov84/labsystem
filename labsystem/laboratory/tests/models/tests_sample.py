...
from labsystem.laboratory.models import Profile, PidType, Sex, Specialty, HealthFacility, Position, Department, City, \
    Country, Analysis, SampleType, ResultStatus, Result, Sample
...
class SampleTests(TestCase):
    ...
    def test_sample_str__when_valid_fields__expect_correct_str_method_result(self):
        s = Sample.objects.all().first()
        expected = f'Name: {s.name}, Analysis: {s.result.analysis}'
        actual = s.__str__()
